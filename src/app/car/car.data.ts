...
import { Car, CarCondition, CarFuelType, CarTransmission, CarType } from './car.interface';
...
function _toCar(raw: RawCar): Car {
	return {
		...
		type: _oneOf<CarType>(raw.type, ['sedan', 'suv', 'hatchback', 'coupe', 'truck', 'van'], 'sedan'),
		...
		transmission: _oneOf<CarTransmission>(raw.transmission, ['automatic', 'manual'], 'automatic'),
		fuelType: _oneOf<CarFuelType>(raw.fuelType, ['petrol', 'diesel', 'electric', 'hybrid'], 'petrol'),
